/*
 ...
 - NOW SESSION-AWARE: Can filter measurements by session_id for multi-session support.
...
/// <summary>
/// PostgreSQL rover data reader (silent library version, session-aware).
/// Notes:
...
/// - Can optionally filter by session_id to support multiple concurrent sessions.
/// </summary>
public class PostgresRoverDataReader : RoverDataReaderBase
{
    ...
    private string BuildSessionFilter()
    {
