...
public class GeoPackageRoverDataReader : RoverDataReaderBase
{
    ...
    public override async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"Opening GeoPackage: {_dbPath}");
            ...
            Console.WriteLine("GeoPackage opened successfully for reading!");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"Error opening GeoPackage: {ex.Message}");
            throw;
        }
    }
